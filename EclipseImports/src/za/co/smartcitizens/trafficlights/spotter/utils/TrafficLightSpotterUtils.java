...
public class TrafficLightSpotterUtils {
	private static final String TRAFFIC_LIGHT_SPOTTER_SERVER_URL ="http://localhost:3000/spotters/traffic/lights";  //http://localhost:3000/  //"http://smartcitizen.defensivethinking.co.za/spotters/traffic/lights";
